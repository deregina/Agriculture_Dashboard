...
class Cc2022_shp(models.Model):
    fid = models.BigIntegerField(blank=True, null=False, primary_key=True)
...
class Shp2022(models.Model):
    fid = models.BigIntegerField(blank=True, null=False, primary_key=True)
    geom = models.MultiPolygonField(srid=32614)

    def __str__(self): return str(self.fid)

class Shp2019(models.Model):
...
class Cc2019(models.Model):
    fid = models.BigIntegerField(db_column='FID', blank=True, null=False, primary_key=True)  # Field name made lowercase.
